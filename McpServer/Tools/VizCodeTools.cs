...
public static class VizCodeTools
{
    [McpServerTool, Description(
        ...
        "Shape methods: Move(new VXYZ(dx,dy,0)), Rotate(pivot,angleDeg), Scale(center,factor), Flip(mirrorLine), Clone(), GetBounds(), Show(), Hide(), Remove(), Contains(point), DistanceTo(point). " +
